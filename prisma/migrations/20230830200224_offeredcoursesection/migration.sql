...
-- AddForeignKey
ALTER TABLE "OfferedCourseSection" ADD CONSTRAINT "OfferedCourseSection_offeredCourseId_fkey" FOREIGN KEY ("offeredCourseId") REFERENCES "offered_course"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
